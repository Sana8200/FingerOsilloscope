...
// Registers are 16-bit wide. We use int pointers and adjust the addresses 
#define TIMER_BASE_ADDR      0x04000020
#define TIMER_STATUS    ((volatile int *)(TIMER_BASE_ADDR + 0x0))  // Offset 0  0x04000020   
#define TIMER_CTRL      ((volatile int *)(TIMER_BASE_ADDR + 0x4))  // Offset 4  0x04000024
#define TIMER_PERIODL   ((volatile int *)(TIMER_BASE_ADDR + 0x8))  // Offset 8  0x04000028
#define TIMER_PERIODH   ((volatile int *)(TIMER_BASE_ADDR + 0xC))  // Offset 12 0x0400002C

// --- Timer Control Register Bits ( from Table 258) ---
